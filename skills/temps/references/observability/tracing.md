...
Apply [hygiene.md](hygiene.md) before enabling production export:
...
For most browser applications, use Temps analytics/Web Vitals plus Sentry-compatible error tracking and keep full OTLP export on the server. See [hygiene.md](hygiene.md).
